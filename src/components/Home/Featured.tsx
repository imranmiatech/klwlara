...
const collections = [
    { id: 1, title: "Vintage & Sourced", description: "Mid-Century Lounge Chair", image: one },
    { id: 2, title: "New Decores", description: "Late-Night Dream Light", image: one },
    { id: 3, title: "New Furnishings", description: "Wood Table with Mid Mirror", image: one },
    ...
    return (
        <div className="bg-[#FEFEFE] w-full">
            <section className="py-16 md:py-32 px-4 md:px-16 lg:px-24 max-w-[1300px] mx-auto">
                ...
                >
                    {collections.slice(0, 4).map((itemData) => (
                        <motion.div
                            key={itemData.id}
                            variants={item}
